    ...
    return (
        <div className="footbar">
            <div className="trademark">
                &copy; Copyright 2022, Shinobix Trademark
            </div>

            <div className="social-media">
                <a href="https://twitter.com/FernanHickman">
                    <svg
                ...
                <a href="https://www.linkedin.com/in/fernando-andres-fernandez-hickman-77882496/">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
                ...
                <a href="https://github.com/fernanhick">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
                ...
                <a href="mailto:fernanhick@gmail.com">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        x="0px"
                        y="0px"
            ...
            <div className="footer-logo">
                <img src={logo} alt="shibonix logo" />
            </div>
        </div>
    );
}
